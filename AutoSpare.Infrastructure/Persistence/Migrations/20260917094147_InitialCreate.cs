        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Pos1Amount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    Pos2Amount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_DailySettlements_CashAmount_NonNegative", "[CashAmount] >= 0");
                    table.CheckConstraint("CK_DailySettlements_Pos1Amount_NonNegative", "[Pos1Amount] >= 0");
                    table.CheckConstraint("CK_DailySettlements_Pos2Amount_NonNegative", "[Pos2Amount] >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Inventories_Quantity_NonNegative", "[Quantity] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PriceChangeHistories_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_PurchaseItems_Quantity_Positive", "[Quantity] > 0");
                    table.CheckConstraint("CK_PurchaseItems_UnitPrice_NonNegative", "[UnitPrice] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Warehouses",
                columns: new[] { "Id", "Address", "Code", "CreatedAt", "IsActive", "LastModifiedAt", "Name" },
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), "فروشگاه مرکزی", "SHOP-01", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), true, null, "انبار مغازه" },
                    { new Guid("22222222-2222-2222-2222-222222222222"), "انبار پشتیبان", "HOME-01", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), true, null, "انبار منزل" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailySettlements_SettlementDate",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PriceChangeHistories_ChangeDate",
                table: "PriceChangeHistories",
                column: "ChangeDate");

            migrationBuilder.CreateIndex(
                name: "IX_PriceChangeHistories_ProductId_ChangeDate",
                table: "PriceChangeHistories",
                columns: new[] { "ProductId", "ChangeDate" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Purchases_PurchaseDate_SupplierId",
                table: "Purchases",
                columns: new[] { "PurchaseDate", "SupplierId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockMovements_WarehouseId_OccurredAt",
                table: "StockMovements",
